...
class PostPremaskModel(AbstractModel):
    def __init__(self, weights_path):
        self.name = "post_premask"
        self.required_inputs = ["post", "premask"]
    ...
    def predict(self, inputs: ModelInput):
        ...
        premask_tensor = inputs.pre_mask

        with torch.no_grad():
            logits, features = self.damage_model(post_tensor, premask_tensor)
